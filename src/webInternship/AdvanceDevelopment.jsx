...
const AdvanceDevelopment = () => {
    ...
    return (
        <>
            ...
            <div id="advance" className="container internship mx-auto max-md:px-3 max-md:pb-0 flex px-16 my-16 md:flex-row flex-col items-center w-11/12 text-black max-sm:text-sm bg-gray-100 rounded-[13px] py-10 max-md:w-full">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-6 md:mb-0 items-center text-center">
                    <div className=" max-sm:text-sm max-sm:px-7 box backdrop-blur-lg bg-slate-900 text-white py-2 px-10 text-lg rounded-r-3xl rounded-l-lg font-bold">
                        Advance Web Development Internship
                    </div>
                    <div className="level flex justify-between w-3/5  max-md:w-full ">
                        <a href='#' className="totalIntenship max-md:px-3 max-sm:px-2 bg-gray-300 py-2 px-8 w-fit mt-5 rounded-3xl cursor-pointer">
