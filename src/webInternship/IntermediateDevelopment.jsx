...
const IntermediateDevelopment = () => {
    ...
    return (
        <>
            ...
            <div id="inter" className="container internship mx-auto flex max-md:px-3 max-md:pb-0 px-16 my-16 md:flex-row flex-col items-center w-11/12 text-black bg-gray-100 rounded-[13px] py-10 max-md:w-full">
