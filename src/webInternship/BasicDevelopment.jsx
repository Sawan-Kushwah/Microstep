...
const BasicDevelopment = () => {
    ...
    return (
        <>
            ...
            <div id="basic" className="container internship mx-auto max-md:px-3 max-md:pb-0 flex px-16 my-16 md:flex-row flex-col items-center w-11/12 text-black bg-gray-100 rounded-[13px] py-10 max-md:w-full">
