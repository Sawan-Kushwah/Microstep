...
const Webdevelopment = () => {
    ...
    return (
        ...
        <>
            ...
            <section id="web" className="d-flex flex-column justify-content-center align-items-center max-md:h-[790px]">
                <div className="hero-container w-full flex justify-around relative z-10 top-36 items-center px-5 max-md:flex-col">
                    <div className="hero-text-section  w-3/5 pl-14 max-md:w-full max-md:pl-0">
                        ...
                        <div className="level flex justify-between w-3/5 max-md:w-full ">
                            <a href="#basic" className="totalIntenship bg-gray-900 py-4 px-8 w-fit max-md:px-4 max-md:py-3 mt-5 rounded-3xl cursor-pointer">
                                <div className="number font-bold text-white text-lg">
                                    BASIC
                                </div>
                            </a>
                            <a href='#inter' className="totalIntenship bg-gray-900 py-4 px-8 w-fit max-md:px-4 max-md:py-3 mt-5 rounded-3xl cursor-pointer">
                                <div className="number font-bold text-white text-lg">
                                    INTERMEDIATE
                                </div>
                            </a>
                            <a href='#advance' className="totalIntenship bg-gray-900 py-4 px-8 w-fit max-md:px-4 max-md:py-3 mt-5 rounded-3xl cursor-pointer">
                                <div className="number font-bold text-white text-lg">
                                    ADVANCE
                                </div>
                            </a>
