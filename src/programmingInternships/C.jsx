...
const C = () => {
    ...
    return (
        <>
            ...
            <div id="c" className="container internship mx-auto flex px-16 max-md:px-3 my-16 md:flex-row flex-col items-center w-11/12 text-black bg-gray-100 rounded-[13px] py-10 max-md:pb-0">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <div className="level flex justify-between w-3/5 max-md:w-full ">
                        <a href='#' className="totalIntenship bg-gray-300 py-2 px-8 w-fit mt-5 max-md:px-3 rounded-3xl cursor-pointer">
