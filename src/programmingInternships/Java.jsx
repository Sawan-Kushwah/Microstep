...
const Java = () => {
    ...
    return (
        <>
            ...
            <div id="java" className="container internship mx-auto flex px-16 my-16 md:flex-row flex-col items-center w-11/12 text-black bg-gray-100 rounded-[13px] py-10 ">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <div className="qualification py-3 pl-16">
                        <ul>
                            ...
                            <li className="py-1.5 list-disc">
                                <div className="courses_list-item flex items-center" >
                                    <p className="courses_card-heading text-size-regular pl-3">Basic proficiency in JAVA programming language
                                    </p>
                                </div>
                            </li>
                            <li className="py-1.5 list-disc">
                        ...
                        <div className="preferredQualification">
                            ...
                            <div className="qualification py-3 pl-16">
                                <ul>
                                    ...
                                    <li className="py-1.5 list-disc">
                                        <div className="courses_list-item flex items-center" >
                                            <p className="courses_card-heading text-size-regular pl-3">Familiarity with Java Standard Library and APIs.</p>
                                        </div>
                                    </li>
                                    <li className="py-1.5 list-disc">
                                        <div className="courses_list-item flex items-center" >
                                            <p className="courses_card-heading text-size-regular pl-3">Experience with basic file handling in Java.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="minimumQualification">
                            ...
                            <div className="qualification py-3 pl-16">
                                <ul>
                                    <li className="py-1.5">
                                        <div className="courses_list-item flex items-center" >
                                            <p className="courses_card-heading text-size-regular pl-3"> <strong>Game Development Projects : </strong>Engage in real-world game development projects where you will apply your knowledge of JAVA programming. </p>
                                        </div>
                                    </li>
                                    <li className="py-1.5">
                                        <div className="courses_list-item flex items-center" >
